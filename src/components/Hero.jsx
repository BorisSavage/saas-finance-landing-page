...
const Hero = () => {
    return (
        <div className="text-slate-200">
            <div className="mx-auto mt-[-96px] flex h-screen w-full max-w-[800px] flex-col justify-center px-4 text-center">
                ...
                <p className="text-lg font-bold text-slate-500 md:text-xl">
                    Monitor your data analytics to increase revenue
                    for&nbsp;BTB, BTC & SAAS platforms.
                </p>
                <button className="my-6 mx-auto w-[200px] rounded-lg bg-tealx py-3 font-bold text-black">
                    Get Started
                </button>
            </div>
        </div>
